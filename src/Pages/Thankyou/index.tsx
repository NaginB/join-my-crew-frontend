    ...
    <C.ThankyouWrapper>
      <C.Content className="min-h-screen flex items-center justify-center flex-col">
        ...
        <p className="text-white text-center font-roboto leading-7 pb-8 pt-4">
          Your application has been received. It is under process and will be
          activated by the fanxo talent team shortly after due diligence. An
          email will be sent to your registered email address once the
          activation process is complete. After activation, you can log in with
          your credentials and access the special creator account and begin
          earning on fanxo.
        </p>
